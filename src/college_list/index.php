        ...
        <thead>
          <tr>
            ...
            <input type="hidden" name="final" value="<?php echo $final; ?>">
              <tr>
              <td><input id="textboxSchool" type="text" name="school" class="form-control" 
          value="<?php echo $school; ?>" placeholder="Enter your school"></td>
              <td><input id="textbox" type="text" name="state" class="form-control" 
        value="<?php echo $state; ?>" placeholder="Enter the state"></td>
              <td><input id="textbox" type="number" name="rank" class="form-control" 
        value="<?php echo $rank; ?>" placeholder="Enter the rank"></td>
        <?php if ($focus == 1): ?>
                          <td><input id="textbox" type="number" name="erank" class="form-control" 
        value="<?php echo $erank; ?>" placeholder="Enter the engineeringrank"></td>
                          <?php elseif ($focus == 2): ?>
                          <td><?php rankConv($row['brank']); ?></td>
                          <?php elseif ($focus == 0): ?>
                          <?php else: ?>
                            <td><td><input id="textbox" type="number" name="erank" class="form-control" 
        value="<?php echo $erank; ?>" placeholder="Enter the engineeringrank"></td></td>
                            <td><?php rankConv($row['brank']); ?></td>
                        <?php endif; ?>
              <td><select name="selecti" >
              <option value="<?php echo $row['selecti']; ?>"><?php echo $row['selecti']; ?></option>
              ...
              <?php 
                            ...
                            ?>
                              <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-outline-success" name="unfinalize">Unfinalize</button>
                              </div>
                            <?php else: ?>
                              <div class="form-group">
                                <button type="submit" class="btn btn-outline-info" name="update">Update</button>
                                <button type="submit" class="btn btn-outline-success" name="finalize">Finalize</button>
                            </div>
                            <?php endif; ?>
              </td>
              </tr>
...
<!--        <div class="box-searchBox">
        <form action="process.php" method="post">
        <input type="text" placeholder="School Name" name = "searchBox" id="searchBox">
        <button type="submit" name = "submitSearch">Add School</button>
        </form>
        </div> -->
    ...
    <div class="row justify-content-center">
      <form action="process.php" method="POST">
        ...
        <input type="number" name="rank" class="form-control" 
          placeholder="Enter the rank" required>
        </div>
